...
def save_initial_schema(
    ...
    if not schema_toml.strip():
        return {"error": True, "message": "schema_toml is empty; generate and review a preview first."}
    ...
    if update_config:
        cfg_path = _upsert_server_config(
            ...
            taxonomy_path=str(Path(taxonomy_path).expanduser().resolve()) if taxonomy_path else None,
        )
